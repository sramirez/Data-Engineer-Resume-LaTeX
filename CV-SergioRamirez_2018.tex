...
\programming{{C $\textbullet$ C++ $\textbullet$ Python / 3}, {Java $\textbullet$ Flink $\textbullet$ \large \LaTeX / 4}, {Scala $\textbullet$ Spark $\textbullet$ R / 5}}
...
Check my GitHub profile, or my Spark packages: \url{https://spark-packages.org/user/sramirez}.
}
%----------------------------------------------------------------------------------------
