...
\begin{twenty}
	\twentyitem
        ...
        {\begin{itemize}
        \item Scalable data reduction (discretization, feature and instance selection) algorithms for Spark. Achievements: fast feature selection on 30M cols (kdd2010), and discretization on 60M rows.
